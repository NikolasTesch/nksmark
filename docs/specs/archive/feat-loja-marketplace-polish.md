...
> **Status:** implementado · **Reconciliado:** 2026-09-13 · **evidência:** `src/components/artwork/ArtworkCard.tsx` (preço :155, hover overlay :119, rodapé dinâmico por role :160), `src/app/loja/page.tsx` (ordenação :25/:125, Suspense :33, empty state :596, voltar ao topo :199/:616), `src/app/loja/[slug]/page.tsx` (breadcrumb :322, related :455, sticky CTA :509, trust badges :437), `src/components/shared/LoadingGrid.tsx` (skeleton 4:5 :7).
