...
> **Status:** implementado · **Reconciliado:** 2026-09-13 · **evidência:** `prisma/schema.prisma` (`model SupportTicket` :140), `src/app/api/support/route.ts`, `src/app/api/admin/support/route.ts` + `[id]`, `src/app/admin/chamados/page.tsx`, link em `src/components/admin/AdminSidebar.tsx` :19.
