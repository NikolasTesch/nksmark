        ...
        <div className="container mx-auto px-4 md:px-8 py-8 md:py-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          ...
          <div className="flex gap-8">
            <div className="flex flex-col">
              <span className="font-display font-extrabold text-2xl md:text-3xl leading-none text-nks-red-light">1.240</span>
              <span className="text-[10px] uppercase tracking-[0.1em] text-white/50 mt-1">artes</span>
            </div>
            <div className="flex flex-col">
              <span className="font-display font-extrabold text-2xl md:text-3xl leading-none text-nks-red-light">6</span>
